...
import EmailImportBanner from './Dashboard/EmailImportBanner';
...
export default function Dashboard() {
    ...
    // Use the hook to get banner data (the global toast already fired from App.jsx)
    const emailNotice = useEmailImportNotification();
    ...
    return (
        <div className="relative w-full h-full">
            ...
            >
                {/* Email Import Notice */}
                <EmailImportBanner
                    count={emailNotice.count}
                    total={emailNotice.total}
                    isDismissed={emailNotice.isDismissed}
